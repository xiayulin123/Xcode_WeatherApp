...
//  Weather
//
//  Created by Yulin Xia on 2024-02-16.
//
...
extension Color {
    ...
    static let tabBarBorder1 = Color("Tab Bar Border").opacity(0.5)
    static let forecastCardBackground1 = Color("Forecast Card Background")
    static let probabilityText1 = Color("Probability Text")
}
